...
abstract class ApiTestCase extends TestCase
{
    ...
    final protected function mockAnnotationListCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(AnnotationsClient::TYPE_ANNOTATION_LIST, Annotations::VERSION_ANNOTATION_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $annotations,
                ])
    ...
    final protected function mockAnnualReportListCall(int $page, int $perPage, int $total, $descendingOrder = true)
    {
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(AnnualReportsClient::TYPE_ANNUAL_REPORT_LIST, AnnualReports::VERSION_ANNUAL_REPORT_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $annualReports,
                ])
    ...
    final protected function mockAnnualReportCall(int $year)
    {
        $this->storage->save(
            new Request(
                ...
                ['Accept' => new MediaType(AnnualReportsClient::TYPE_ANNUAL_REPORT, AnnualReports::VERSION_ANNUAL_REPORT)]
            ),
            new Response(
                200,
                ['Content-Type' => new MediaType(AnnualReportsClient::TYPE_ANNUAL_REPORT, AnnualReports::VERSION_ANNUAL_REPORT)],
    ...
    final protected function mockArticleListCall(
        ...
        $this->storage->save(
            new Request(
                ...
                ['Accept' => new MediaType(ArticlesClient::TYPE_ARTICLE_LIST, Articles::VERSION_ARTICLE_LIST)]
            ),
            new Response(
                200,
                ['Content-Type' => new MediaType(ArticlesClient::TYPE_ARTICLE_LIST, Articles::VERSION_ARTICLE_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $articles,
                ])
    ...
    final protected function mockArticleHistoryCall($numberOrId, bool $complete = false)
    {
        ...
        $response = new Response(
            200,
            ['Content-Type' => new MediaType(ArticlesClient::TYPE_ARTICLE_HISTORY, Articles::VERSION_ARTICLE_HISTORY)],
        ...
        $this->storage->save(
            new Request(
                ...
                [
                    'Accept' => [
                        new MediaType(ArticlesClient::TYPE_ARTICLE_HISTORY, Articles::VERSION_ARTICLE_HISTORY),
                    ],
                ]
            ),
            $response
    ...
    final protected function mockRelatedArticlesCall($numberOrId, bool $complete = false)
    {
        ...
        $response = new Response(
            200,
            ['Content-Type' => new MediaType(ArticlesClient::TYPE_ARTICLE_RELATED, Articles::VERSION_ARTICLE_RELATED)],
        ...
        $this->storage->save(
            new Request(
                ...
                [
                    'Accept' => [
                        new MediaType(ArticlesClient::TYPE_ARTICLE_RELATED, Articles::VERSION_ARTICLE_RELATED),
                    ],
                ]
            ),
            $response
    ...
    final protected function mockArticleCall($numberOrId, bool $complete = false, bool $vor = false, int $version = null)
    {
        ...
        if ($vor) {
            $response = new Response(
                200,
                ['Content-Type' => new MediaType(ArticlesClient::TYPE_ARTICLE_VOR, Articles::VERSION_ARTICLE_VOR)],
                json_encode($this->createArticleVoRJson($id, false, $complete, $version ?? 1))
            );
        } else {
            $response = new Response(
                200,
                ['Content-Type' => new MediaType(ArticlesClient::TYPE_ARTICLE_POA, Articles::VERSION_ARTICLE_POA)],
    ...
    final protected function mockBlogArticleListCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(BlogClient::TYPE_BLOG_ARTICLE_LIST, BlogArticles::VERSION_BLOG_ARTICLE_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $blogArticles,
                ])
    ...
    final protected function mockBlogArticleCall($numberOrId, bool $complete = false)
    {
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(BlogClient::TYPE_BLOG_ARTICLE, BlogArticles::VERSION_BLOG_ARTICLE)],
    ...
    final protected function mockCommunityListCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(CommunityClient::TYPE_COMMUNITY_LIST, Community::VERSION_COMMUNITY_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $blogArticles,
                ])
    ...
    final protected function mockCoverListCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(CoversClient::TYPE_COVERS_LIST, Covers::VERSION_COVERS_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $covers,
                ])
    ...
    final protected function mockEventListCall(
        ...
        $this->storage->save(
            new Request(
                ...
                ['Accept' => new MediaType(EventsClient::TYPE_EVENT_LIST, Events::VERSION_EVENT_LIST)]
            ),
            new Response(
                200,
                ['Content-Type' => new MediaType(EventsClient::TYPE_EVENT_LIST, Events::VERSION_EVENT_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $events,
                ])
    ...
    final protected function mockEventCall(int $number, bool $complete = false, bool $external = false)
    {
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(EventsClient::TYPE_EVENT, Events::VERSION_EVENT)],
    ...
    final protected function mockJobAdvertListCall(
        ...
        $this->storage->save(
            new Request(
                ...
                ['Accept' => new MediaType(JobAdvertsClient::TYPE_JOB_ADVERT_LIST, JobAdverts::VERSION_JOB_ADVERT_LIST)]
            ),
            new Response(
                200,
                ['Content-Type' => new MediaType(JobAdvertsClient::TYPE_JOB_ADVERT_LIST, JobAdverts::VERSION_JOB_ADVERT_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $jobAdverts,
                ])
    ...
    final protected function mockJobAdvertCall(int $number, bool $isUpdated = false)
    {
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(JobAdvertsClient::TYPE_JOB_ADVERT, JobAdverts::VERSION_JOB_ADVERT)],
    ...
    final protected function mockHighlightsCall(string $id, int $page, int $perPage, int $total, $descendingOrder = true, bool $complete = false)
    {
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(HighlightsClient::TYPE_HIGHLIGHT_LIST, Highlights::VERSION_HIGHLIGHT_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $highlights,
                ])
    ...
    final protected function mockInterviewListCall(int $page, int $perPage, int $total, $descendingOrder = true)
    {
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(InterviewsClient::TYPE_INTERVIEW_LIST, Interviews::VERSION_INTERVIEW_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $interviews,
                ])
    ...
    final protected function mockInterviewCall($numberOrId, bool $complete = false)
    {
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(InterviewsClient::TYPE_INTERVIEW, Interviews::VERSION_INTERVIEW)],
    ...
    final protected function mockLabsPostListCall(int $page, int $perPage, int $total, $descendingOrder = true)
    {
        ...
        $this->storage->save(
            new Request(
                ...
                ['Accept' => new MediaType(LabsClient::TYPE_POST_LIST, LabsPosts::VERSION_POST_LIST)]
            ),
            new Response(
                200,
                ['Content-Type' => new MediaType(LabsClient::TYPE_POST_LIST, LabsPosts::VERSION_POST_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $labsPosts,
                ])
    ...
    final protected function mockLabsPostCall(string $id, bool $complete = false)
    {
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(LabsClient::TYPE_POST, LabsPosts::VERSION_POST)],
    ...
    final protected function mockMediumArticleListCall(int $page, int $perPage, int $total, $descendingOrder = true)
    {
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(MediumClient::TYPE_MEDIUM_ARTICLE_LIST, MediumArticles::VERSION_MEDIUM_ARTICLE_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $articles,
                ])
    ...
    final protected function mockMetricCitationsCall(string $type, string $id)
    {
        $this->storage->save(
            new Request(
                ...
                ['Accept' => new MediaType(MetricsClient::TYPE_METRIC_CITATIONS, Metrics::VERSION_METRIC_CITATIONS)]
            ),
            new Response(
                200,
                ['Content-Type' => new MediaType(MetricsClient::TYPE_METRIC_CITATIONS, Metrics::VERSION_METRIC_CITATIONS)],
                json_encode([
                    [
                        'service' => 'Service',
    ...
    final protected function mockMetricDownloadsCall(string $type, string $id)
    {
        $this->storage->save(
            new Request(
                ...
                ['Accept' => new MediaType(MetricsClient::TYPE_METRIC_TIME_PERIOD, Metrics::VERSION_METRIC_TIME_PERIOD)]
            ),
            new Response(
                200,
                ['Content-Type' => new MediaType(MetricsClient::TYPE_METRIC_TIME_PERIOD, Metrics::VERSION_METRIC_TIME_PERIOD)],
                json_encode([
                    'totalPeriods' => 1,
                    'totalValue' => (int) $id,
                    'periods' => [
    ...
    final protected function mockPersonListCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(PeopleClient::TYPE_PERSON_LIST, People::VERSION_PERSON_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $people,
                ])
    ...
    final protected function mockPersonCall($numberOrId, bool $complete = false, bool $isSnippet = false)
    {
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(PeopleClient::TYPE_PERSON, People::VERSION_PERSON)],
    ...
    final protected function mockPodcastEpisodeListCall(
        ...
        $this->storage->save(
            new Request(
                ...
                ['Accept' => new MediaType(PodcastClient::TYPE_PODCAST_EPISODE_LIST, PodcastEpisodes::VERSION_PODCAST_EPISODE_LIST)]
            ),
            new Response(
                200,
                ['Content-Type' => new MediaType(PodcastClient::TYPE_PODCAST_EPISODE_LIST, PodcastEpisodes::VERSION_PODCAST_EPISODE_LIST)],
                json_encode([
                    'total' => $total,
    ...
    final protected function mockPodcastEpisodeCall(int $number, bool $complete = false)
    {
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(PodcastClient::TYPE_PODCAST_EPISODE, PodcastEpisodes::VERSION_PODCAST_EPISODE)],
    ...
    final protected function mockPressPackagesListCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(PressPackagesClient::TYPE_PRESS_PACKAGE_LIST, PressPackages::VERSION_PRESS_PACKAGE_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $pressPackages,
                ])
    ...
    final protected function mockPressPackageCall($numberOrId, bool $complete = false)
    {
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(PressPackagesClient::TYPE_PRESS_PACKAGE, PressPackages::VERSION_PRESS_PACKAGE)],
    ...
    final protected function mockProfileListCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(ProfilesClient::TYPE_PROFILE_LIST, Profiles::VERSION_PROFILE_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $profiles,
                ])
    ...
    final protected function mockProfileCall($numberOrId, bool $complete = false, bool $isSnippet = false)
    {
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(ProfilesClient::TYPE_PROFILE, Profiles::VERSION_PROFILE)],
    ...
    final protected function mockCollectionListCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(CollectionsClient::TYPE_COLLECTION_LIST, Collections::VERSION_COLLECTION_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $collections,
                ])
    ...
    final protected function mockCollectionCall(string $id, bool $complete = true)
    {
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(CollectionsClient::TYPE_COLLECTION, Collections::VERSION_COLLECTION)],
    ...
    final protected function mockDigestListCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(DigestsClient::TYPE_DIGEST_LIST, Digests::VERSION_DIGEST_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $digests,
                ])
    ...
    final protected function mockDigestCall(string $id, bool $complete = true)
    {
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(DigestsClient::TYPE_DIGEST, Digests::VERSION_DIGEST)],
    ...
    final protected function mockRecommendationsCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(RecommendationsClient::TYPE_RECOMMENDATIONS, Recommendations::VERSION_RECOMMENDATIONS)],
                json_encode([
                    'total' => $total,
    ...
    final protected function mockSearchCall(
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(SearchClient::TYPE_SEARCH, Search::VERSION_SEARCH)],
                json_encode([
                    'total' => $total,
                    'items' => $results,
                    'subjects' => [
    ...
    final protected function mockSubjectListCall(int $page, int $perPage, int $total, $descendingOrder = true)
    {
        ...
        $this->storage->save(
            new Request(
                ...
                ['Accept' => new MediaType(SubjectsClient::TYPE_SUBJECT_LIST, Subjects::VERSION_SUBJECT_LIST)]
            ),
            new Response(
                200,
                ['Content-Type' => new MediaType(SubjectsClient::TYPE_SUBJECT_LIST, Subjects::VERSION_SUBJECT_LIST)],
                json_encode([
                    'total' => $total,
                    'items' => $subjects,
                ])
    ...
    final protected function mockSubjectCall($numberOrId, bool $complete = false, bool $isSnippet = false)
    {
        ...
        $this->storage->save(
            ...
            new Response(
                200,
                ['Content-Type' => new MediaType(SubjectsClient::TYPE_SUBJECT, Subjects::VERSION_SUBJECT)],
