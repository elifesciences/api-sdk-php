...
final class PersonTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $person = new Person('id', $details = new PersonDetails('preferred name', 'index name'), 'senior-editor', 'title', null,
            rejection_for('Research should not be unwrapped'),
            new PromiseSequence(rejection_for('Profile should not be unwrapped')),
            rejection_for('Competing interests should not be unwrapped'));
    ...
    {
        $with = new Person('id', new PersonDetails('preferred name', 'index name'), 'senior-editor', 'title',
            $image = Builder::for(Image::class)->sample('thumbnail'),
            rejection_for('Research should not be unwrapped'),
            new PromiseSequence(rejection_for('Profile should not be unwrapped')),
            rejection_for('Competing interests should not be unwrapped'));
        $withOut = new Person('id', new PersonDetails('preferred name', 'index name'), 'senior-editor', 'title', null,
            rejection_for('Research should not be unwrapped'),
            new PromiseSequence(rejection_for('Profile should not be unwrapped')),
            rejection_for('Competing interests should not be unwrapped'));
    ...
    {
        $with = new Person('id', new PersonDetails('preferred name', 'index name'), 'senior-editor', 'title', null,
