...
final class ClinicalTrialReferenceTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $reference = new ClinicalTrialReference($authors = [
            new PersonAuthor(new Person('preferred name', 'index name')),
        ], false, ClinicalTrialReference::AUTHOR_TYPE_AUTHORS, 'title', 'http://www.example.com/');
    ...
    {
        $with = new ClinicalTrialReference([new PersonAuthor(new Person('preferred name', 'index name'))], true,
            ClinicalTrialReference::AUTHOR_TYPE_AUTHORS, 'title', 'http://www.example.com/');
        $withOut = new ClinicalTrialReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            ClinicalTrialReference::AUTHOR_TYPE_AUTHORS, 'title', 'http://www.example.com/');
    ...
    {
        $reference = new ClinicalTrialReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            ClinicalTrialReference::AUTHOR_TYPE_AUTHORS, 'title', 'http://www.example.com/');
