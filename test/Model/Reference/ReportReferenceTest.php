...
final class ReportReferenceTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $reference = new ReportReference($authors = [new PersonAuthor(new Person('preferred name', 'index name'))],
    ...
    {
        $with = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], true,
            'title', new Place(null, null, ['publisher']));
        $withOut = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            'title', new Place(null, null, ['publisher']));
    ...
    {
        $reference = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            'title', $report = new Place(null, null, ['publisher']));
    ...
    {
        $with = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            'title', new Place(null, null, ['publisher']), '10.1000/182');
        $withOut = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            'title', new Place(null, null, ['publisher']));
    ...
    {
        $with = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            'title', new Place(null, null, ['publisher']), null, 18183754);
        $withOut = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            'title', new Place(null, null, ['publisher']));
    ...
    {
        $with = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            'title', new Place(null, null, ['publisher']), null, null, '978-3-16-148410-0');
        $withOut = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            'title', new Place(null, null, ['publisher']));
    ...
    {
        $with = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            'title', new Place(null, null, ['publisher']), null, null, null, 'http://www.example.com/');
        $withOut = new ReportReference([new PersonAuthor(new Person('preferred name', 'index name'))], false,
            'title', new Place(null, null, ['publisher']));
