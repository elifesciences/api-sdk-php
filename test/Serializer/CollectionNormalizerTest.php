...
final class CollectionNormalizerTest extends ApiTestCase
{
    ...
    protected function samples()
    {
        ...
        yield __DIR__."/../../vendor/elife/api/dist/samples/community-list/v2/*.json#items[?type=='collection']";
        yield __DIR__."/../../vendor/elife/api/dist/samples/search/v2/*.json#items[?type=='collection']";
    }
}
